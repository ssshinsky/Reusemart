...
['form-nonaktif', 'form-reactivate'].forEach(cls => {
    document.querySelectorAll(`.${cls}`).forEach(form => {
        form.addEventListener('submit', function(e) {
            e.preventDefault();
            Swal.fire({
                title: cls === 'form-nonaktif' ? 'Nonaktifkan organisasi?' : 'Aktifkan kembali organisasi?',
                text: cls === 'form-nonaktif' ? 'Data organisasi akan dinonaktifkan!' : 'Organisasi ini akan aktif kembali.',
