...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="{{ route('admin.roles.index') }}" class="menu-item">💼 Roles</a>
            <a href="{{ route('admin.penitip.index') }}" class="menu-item">📦 Item Owners</a>
            <a href="{{ route('admin.pembeli.index') }}" class="menu-item">🛍️ Customers</a>
            <a href="{{ route('admin.organisasi.index') }}" class="menu-item">🏢 Organizations</a>
            <a href="{{ route('admin.produk.index') }}" class="menu-item">🏷️ Products</a>
            <a href="{{ route('admin.merch.index') }}" class="menu-item">🎁 Merchandise</a>
        </div>
