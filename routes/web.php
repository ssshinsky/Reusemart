...
Route::prefix('admin')->group(function () {
    ...
    Route::put('/item-owners/{id}/reset-password', [PenitipController::class, 'resetPassword'])->name('admin.penitip.reset-password');
...
>>>>>>> 2d5bf5b27ef4311a355dd16a1faed86d6ebb72cb
});
